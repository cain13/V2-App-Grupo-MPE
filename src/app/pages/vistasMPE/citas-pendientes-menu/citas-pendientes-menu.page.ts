...
@Component({
  ...
  templateUrl: './citas-pendientes-menu.page.html',
  styleUrls: ['./citas-pendientes-menu.page.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class CitasPendientesMenuPage implements OnInit, ViewDidLeave {
  searchKey = '';
  listaAsistencias = [];
