...
@Component({
  ...
  templateUrl: './documentos-trabajador-menu.page.html',
  styleUrls: ['./documentos-trabajador-menu.page.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class DocumentosTrabajadorMenuPage implements OnInit, ViewWillEnter, ViewDidLeave {
