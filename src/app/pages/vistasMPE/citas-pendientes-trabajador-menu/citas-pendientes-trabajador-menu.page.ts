...
@Component({
  ...
  templateUrl: './citas-pendientes-trabajador-menu.page.html',
  styleUrls: ['./citas-pendientes-trabajador-menu.page.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class CitasPendientesTrabajadorMenuPage implements OnInit {
  searchKey = '';
  listaCitas = [];
