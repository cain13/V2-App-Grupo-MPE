...
@Component({
  ...
  templateUrl: './certificado-aptitud-menu.page.html',
  styleUrls: ['./certificado-aptitud-menu.page.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class CertificadoAptitudMenuPage implements OnInit, ViewDidLeave, ViewWillEnter {
  listaCertificados = [];
  searchKey = '';
