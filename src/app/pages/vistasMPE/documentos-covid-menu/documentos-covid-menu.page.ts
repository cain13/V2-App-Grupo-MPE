...
@Component({
  ...
  templateUrl: './documentos-covid-menu.page.html',
  styleUrls: ['./documentos-covid-menu.page.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class DocumentosCovidMenuPage implements ViewDidLeave, ViewWillEnter {
